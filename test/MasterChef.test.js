...
contract('MasterChef', ([alice, bob, carol, referrer, treasury, dev, fee, owner]) => {
    beforeEach(async () => {
        ...
        this.boltrswap = await BoltrSwap.new({ from: owner });
        this.chef = await MasterChef.new(this.boltrswap.address, '100', '1000', { from: owner });

        await this.boltrswap.transferOwnership(this.chef.address, { from: owner });

        this.lp1 = await MockKRC20.new('LPToken', 'LP1', '1000000', { from: owner });
        this.lp2 = await MockKRC20.new('LPToken', 'LP2', '1000000', { from: owner });
        this.lp3 = await MockKRC20.new('LPToken', 'LP3', '1000000', { from: owner });
        this.lp4 = await MockKRC20.new('LPToken', 'LP4', '1000000', { from: owner });
